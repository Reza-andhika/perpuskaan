        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open('dataset/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="judul" class="form-control" placeholder="Masukan Judul Dalam Bahasa Indonesia" value="<?php echo set_value('Judul'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea type="text" name="sinopsis" class="form-control" rows="14" value="<?php echo set_value('Sinopsis'); ?>"> </textarea>
                    </div>
                </div>
